...
namespace MojeAutCcentrum.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        private Connection db = Connection.Create();
        ...
        public async Task<ActionResult> AddAvatar(AddAvatar model)
        {
            ...
            try
            {
                var newModel = new Avatar() { Name = model.File.FileName, Size = model.File.ContentLength, UserId = user.Id, Fream = date};
        ...
        public async Task<ActionResult> ChangeAvatar()
        {
            ...
            return View(new ChangeAvatar { Avatar = avatar, File = null });
        }
        ...
        public ActionResult DeleteAvatar()
        {
            ...
            var ViewModels = new DeleteAvatar { Avatar = Convert.ToBase64String(Avatar.Fream, 0, Avatar.Size), id = Avatar.Id };
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult DeleteAvatar(DeleteAvatar model)
        {
            if (ModelState.IsValid)
            {
        ...
        private bool HasAvatar()
        {
            ...
            if (user != null)
            {
                return db.Avatar.FirstOrDefault(x => x.UserId == user.Id) == null ? false : true;
            }
            return false;
        }
